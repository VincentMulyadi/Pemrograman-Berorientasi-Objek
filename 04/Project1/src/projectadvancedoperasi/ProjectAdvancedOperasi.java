...
public class ProjectAdvancedOperasi {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(p.jumlahkan(3.5,4));
        System.out.println(p.jumlahkan(4, 7, -9));
        System.out.println(p.jumlahkan(3.4, -0.002, 0.12313));
        System.out.println(p.perkalian(3.5,4));
        System.out.println(p.perkalian(4, 7, -9));
        System.out.println(p.perkalian(3.4, -0.002, 0.12313));
    }
